            ...
            /*mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                    new AlertDialog.Builder(getActivity())
                            .setTitle("Utilisateur débloquer")
                            .setMessage("Veut tu débloquer l'utilisateur ?")
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    SendBird.unblockUser(target, new SendBird.UserUnblockHandler() {
                                        ...
                                        public void onUnblocked(SendBirdException e) {
                                            ...
                                            Toast.makeText(getActivity(), target.getNickname() + " est débloquer.", Toast.LENGTH_SHORT).show();
