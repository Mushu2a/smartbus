package com.m1.lesbuteurs.smartbus.sendbird;
        ...
        switch (requestCode) {
            case Helper.MY_PERMISSION_REQUEST_STORAGE:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED &&
                    ...
                    Toast.makeText(this, "Permission annuler.", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    public static class SendBirdChatFragment extends Fragment {
        ...
        private void initUIComponents(View rootView) {
            ...
            mBtnUpload.setOnClickListener(new View.OnClickListener() {
                ...
                if (Helper.requestReadWriteStoragePermissions(getActivity())) {
                    ...
                    startActivityForResult(Intent.createChooser(intent, "Selectionner l'image"), REQUEST_PICK_IMAGE);
            ...
            mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                new AlertDialog.Builder(getActivity())
                    .setTitle("Selection")
                    .setItems(new String[]{"Supprimer Message"}, new DialogInterface.OnClickListener() {
                        @Override
                        ...
                        switch (which) {
                            case 0:
                                ...
                                mOpenChannel.deleteMessage(msg0, new BaseChannel.DeleteMessageHandler() {
                                    ...
                                    Toast.makeText(getActivity(), "Message supprimer.", Toast.LENGTH_SHORT).show();
                            ...
                            case 1:
                                ...
                                if (msg1 instanceof AdminMessage) {
                                    Toast.makeText(getActivity(), "Admin message ne peut être supprimer.", Toast.LENGTH_SHORT).show();
                                    return;
                                ...
                                SendBird.blockUser(target, new SendBird.UserBlockHandler() {
                                    ...
                                    Toast.makeText(getActivity(), user.getNickname() + " est bloqués.", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                break;
                        }
        ...
        private void send() {
            mOpenChannel.sendUserMessage(mEtxtMessage.getText().toString(), new BaseChannel.SendUserMessageHandler() {
                ...
                String to = "1:941501361660:android:8c4cec3625b3a502";
                fm.send(new RemoteMessage.Builder(to)
                    .addData("Nouveau message", "" + userMessage)
                    .build());
                }
            });
        ...
        private void upload(Uri uri) {
            ...
            if (path == null) {
                Toast.makeText(getActivity(), "Le téléchargement du fichier doit se faire dans un espace de stockage local.", Toast.LENGTH_LONG).show();
            } else {
                ...
                case TYPE_FILE_MESSAGE:
                    ...
                    viewHolder.getView("img_file_container").setOnClickListener(new View.OnClickListener() {
                        ...
                        new AlertDialog.Builder(mContext)
                            .setTitle("SmartBus")
                            .setMessage("Veux tu télécharger le fichier ?")
